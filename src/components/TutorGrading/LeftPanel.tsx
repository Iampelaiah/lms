...
export default function LeftPanel({ onMarksChange, initialMarks, isReadOnly = false }: LeftPanelProps = {}) {
  ...
  return (
    <div className="w-[320px] bg-obsidian border-r border-white/10 h-full flex flex-col flex-shrink-0 overflow-y-auto hide-scrollbar">
      ...
      <div className="mt-auto p-6 bg-obsidian border-t border-white/10 sticky bottom-0">
        <Button variant="outline" className="w-full h-10 border-white/10 bg-white/5 hover:bg-white/10 text-white font-bold transition-all">
          <Download className="w-4 h-4 mr-2 text-royal" />
          Download Mark Sheet
        </Button>
      </div>
    </div>
